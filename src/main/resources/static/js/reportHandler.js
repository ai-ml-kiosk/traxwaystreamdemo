function submitToFlow() {
	...
	if (document.getElementById("sendSyncpLink").checked) {
		data["sendSyncPLink"] = true;
	} else {
		data["sendSyncPLink"] = false;
	}
	...
	data["emailAddrSyncPTxt"] = document.getElementById("emailAddrSyncPTxt").value;
	
	data["stFolder"] = document.getElementById("stTargetFolder").value;
	
	data["reportName"] = document.getElementById("reportNameTxt").value;
	
	var xhr = new XMLHttpRequest();
	  xhr.open("POST", "https://test-e4e6d0cc6b9ae2c3016b9c0332cb0161.apicentral.axwayamplify.com/ReportGenerator_sandbox_flow_402360-/executions" , true);
